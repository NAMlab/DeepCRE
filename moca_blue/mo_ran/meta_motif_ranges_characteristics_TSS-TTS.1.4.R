...
SPEC="Sobi"
MODEL="M0"
FILE= "arabidopsis_SSR_modisco.hdf5"
#########################################################################################################################
dirpath_in = "./out"
dirpath_out = "./out"
############################################################
...
write.csv(result1, file=paste0(file_path_out,"-TSS_motif_ranges.csv"), row.names=FALSE)
write.csv(result2, file=paste0(file_path_out,"-TTS_motif_ranges.csv"), row.names=FALSE)