...
x0 <- rbind(x,z)
############################################################################
feat_annot0<- merge(y, x0, by = "loc_ID")
feat_annot1 <- feat_annot0
feat_annot2 <- feat_annot1[, c("loc_ID",
                           "type.y",
                           "start.y",
                           "end.y")]
...
write.csv(a0_DF_bed, file=paste0(file_path_out,
                                "-def.bed"), row.names=FALSE)
write.csv(a0_mima_bed, file=paste0(file_path_out,
                                  "-mima.bed"), row.names=FALSE)
write.csv(a0_q1q9_df, file=paste0(file_path_out,
                                  "-q1q9.bed"), row.names=FALSE)
write.csv(feat_anno_mima01, file=paste0(file_path_out,
                                        "feat_mima_q1q9.csv"), row.names = FALSE)
##############################################################
