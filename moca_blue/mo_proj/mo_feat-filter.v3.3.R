...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
#   #   #   #   #  #  #   #   #   #  #  #  #  #  #  #  #  #
file4 <- "outSolS0-14sols_0e5-cwm-20230830.txt"    #   These are the filtered results of the the BLAMM output occurence.txt
#   #   #   #   #  #  #   #   #   #  #  #  #  #  #  #  #  #
file1 <- "SolyS0-TSS_motif_ranges_q1q9.csv"         # These are the summary statistics of the seqlet distribution of the HDF5 file  
file2 <- "SolyS0-TTS_motif_ranges_q1q9.csv"         # These are the summary statistics of the seqlet distribution of the HDF5 file
file3 <- "ITAG4.0_gene_models.gff" # Genome annotation file  #### CODE HERE EXTRACTS NOT COMPLETE GFFF! NEED TO UPDATE CORRECT !!! ASAP
#   #   #   #   #  #  #   #   #   #  #  #  #  #  #  #  #  #
...
write.table(feat_anno_mima01, file=paste0(file_path_out,"feat_mima.csv"), row.names = FALSE, sep = "\t",)
write.table(feat_anno_mimaW01, file=paste0(file_path_out,"feat_mima_weight.csv"), row.names = FALSE, sep = "\t",)
