...
for (pattern_name in pattern_names) {
  ...
  matrixF0 <- metacluster_group[["metacluster_0"]][["seqlets_to_patterns_result"]][["patterns"]][[pattern_name]][["sequence"]][["fwd"]]
  matrixF1 <- metacluster_group[["metacluster_1"]][["seqlets_to_patterns_result"]][["patterns"]][[pattern_name]][["sequence"]][["fwd"]]
  matrixR0 <- metacluster_group[["metacluster_0"]][["seqlets_to_patterns_result"]][["patterns"]][[pattern_name]][["sequence"]][["rev"]]
  matrixR1 <- metacluster_group[["metacluster_1"]][["seqlets_to_patterns_result"]][["patterns"]][[pattern_name]][["sequence"]][["rev"]]
  #pfms in sequence
...
writeLines(unlist(text), paste0(NAME0,SPEC,MODEL,"_pfm-motifs.jaspar"))
#####################################################################################
